...
Java_cn_codekong_paddle_ocr_OCRPredictorNative_init(
...
Java_cn_codekong_paddle_ocr_OCRPredictorNative_forward(
...
Java_cn_codekong_paddle_ocr_OCRPredictorNative_release(
